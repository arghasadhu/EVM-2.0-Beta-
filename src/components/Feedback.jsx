        ...
        <div className='flex flex-col p-4 justify-center max-w-screen-lg mx-auto h-full'>
            ...
            <div className='flex items-center justify-center'>
                <form action="https://getform.io/f/2ab46948-0f96-493c-8ec9-f0f839883e45" method='POST' className='flex flex-col w-full md:w-1/2'>
                    <input type="text"
                    name='name' placeholder='Enter your Name' className='p-2 bg-transparent border-2 rounded-md text-black focus:outline-none' />
                <textarea name="message" id=""  rows="10" placeholder='Write your thoughts about our work...' className='my-4 p-2 bg-transparent border-2 rounded-md focus:outline-none'></textarea>
